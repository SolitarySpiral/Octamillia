...
Статус: В разработке
0.1.6 Добавлена кафка, 2 паралельных вида транспорта сообщений в ахитектуре. Тесты pytest не обновлялись.
Измненена реализация тентакли brokerage, добавлено сердце, изменена связь мозга с сердцем и транспортом сообщений.
---
